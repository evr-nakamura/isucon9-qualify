...
CREATE TABLE `items` (
  ...
  INDEX items_seller_id_created_at_idx (seller_id, created_at),
  INDEX items_buyer_id_created_at_idx (buyer_id, created_at),
  INDEX items_category_id_created_at_idx (category_id, created_at)
) ENGINE=InnoDB DEFAULT CHARACTER SET utf8mb4;
